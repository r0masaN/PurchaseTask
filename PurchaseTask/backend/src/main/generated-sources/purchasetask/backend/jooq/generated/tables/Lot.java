...
public class Lot extends TableImpl<LotRecord> {
    ...
    /**
     * The column <code>purchase.lot.currecy_code</code>.
     */
    public final TableField<LotRecord, String> CURRECY_CODE = createField(DSL.name("currecy_code"), SQLDataType.VARCHAR.nullable(false), this, "");
     ...
     */
    public final TableField<LotRecord, String> PLACE_DELIVERY = createField(DSL.name("place_delivery"), SQLDataType.VARCHAR.nullable(false), this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function8<? super String, ? super String, ? super BigDecimal, ? super String, ? super String, ? super String, ? super LocalDateTime, ? super Integer, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function8<? super String, ? super String, ? super BigDecimal, ? super String, ? super String, ? super String, ? super LocalDateTime, ? super Integer, ? extends U> from) {
